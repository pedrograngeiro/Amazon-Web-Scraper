...
def rodando_checkagem_de_precos():
    ...
    lista_urls_paginas = paginas.obter_lista_urls_paginas(url_pesquisa, total_paginas)
    for i, url_pagina in enumerate(lista_urls_paginas, 1):
        print(f"Verificando página {i} de {total_paginas}...")
